...
public class NyxEntityFallingStar extends Entity {
    ...
    protected void customUpdate() {
        ...
        if (!this.world.isRemote) {
            if (this.collided) {
                this.world.playSound(null, this.posX, this.posY, this.posZ, NyxSoundEvents.ENTITY_STAR_IMPACT.getSoundEvent(), SoundCategory.AMBIENT, (float) NyxConfig.FALLING_STARS.volumeImpact, 1);
