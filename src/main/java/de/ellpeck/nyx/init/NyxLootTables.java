...
public class NyxLootTables {
    ...
    public static final ResourceLocation ALIEN_KITTY_KREKNORITE = new ResourceLocation(Nyx.ID, "entities/alien_kitty_kreknorite");
    public static final ResourceLocation COMET_KITTY_METEORITE = new ResourceLocation(Nyx.ID, "entities/comet_kitty_meteorite");
}
